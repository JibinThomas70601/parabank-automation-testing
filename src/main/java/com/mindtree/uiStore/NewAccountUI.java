...
public class NewAccountUI {
	...
	public static By newaccount = By.xpath("//a[normalize-space()='Open New Account']");
	public static By opennewaccount = By.xpath("//input[@value='Open New Account']");
	
	public static By accountUOpened = By.xpath("//p[normalize-space()='Congratulations, your account is now open.']");
	public static By home = By.xpath("//a[normalize-space()='home']");
